...
public class PrintServiceExporter extends JRAbstractExporter implements Printable {
    ...
    public void exportReport() throws JRException {
        ...
        try {
            ...
            PrintServiceAttributeSet printServiceAttributeSet = (PrintServiceAttributeSet) parameters
                    .get(JRPrintServiceExporterParameter.PRINT_SERVICE_ATTRIBUTE_SET);
            ...
            Boolean pageDialogOnlyOnce = (Boolean) parameters
                    .get(JRPrintServiceExporterParameter.DISPLAY_PAGE_DIALOG_ONLY_ONCE);
            ...
            Boolean printDialogOnlyOnce = (Boolean) parameters
                    .get(JRPrintServiceExporterParameter.DISPLAY_PRINT_DIALOG_ONLY_ONCE);
            ...
            for (reportIndex = 0; reportIndex < jasperPrintList.size(); reportIndex++) {
                ...
                exporter.setParameter(JRExporterParameter.PROGRESS_MONITOR,
                        parameters.get(JRExporterParameter.PROGRESS_MONITOR));
                ...
                exporter.setParameter(JRGraphics2DExporterParameter.ZOOM_RATIO,
                        parameters.get(JRGraphics2DExporterParameter.ZOOM_RATIO));
                ...
                exporter.setParameter(JRGraphics2DExporterParameter.MINIMIZE_PRINTER_JOB_SIZE,
                        parameters.get(JRGraphics2DExporterParameter.MINIMIZE_PRINTER_JOB_SIZE));
                ...
                try {
...

                    {
                        ...
                        pageFormat.setPaper(paper);
                        Book xBook = new Book();
                        xBook.append(this, pageFormat, jasperPrint.getPages().size());
                        printerJob.setPageable(xBook);
                        /*************页面打印大小的问题结束*****************/
                    }
    ...
    private void setOrientation(JasperPrint jPrint, PrintRequestAttributeSet printRequestAttributeSet) {
        if (!printRequestAttributeSet.containsKey(MediaPrintableArea.class)) {
            ...
            printRequestAttributeSet.add(new MediaPrintableArea(0f, 0f, printableWidth / 72f, printableHeight / 72f,
    ...
    private void setDefaultPrintRequestAttributeSet(PrintRequestAttributeSet printRequestAttributeSet) {
        PrintRequestAttributeSet printRequestAttributeSetParam = (PrintRequestAttributeSet) parameters
                .get(JRPrintServiceExporterParameter.PRINT_REQUEST_ATTRIBUTE_SET);
